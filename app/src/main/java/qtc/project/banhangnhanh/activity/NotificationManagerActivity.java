...
import qtc.project.banhangnhanh.admin.fragment.notification.FragmentNotification;
import qtc.project.banhangnhanh.admin.views.action_bar.base_main_actionbar.BaseMainActionbarViewInterface;
import qtc.project.banhangnhanh.admin.views.activity.notify_manager_activity.NotificationManagerActivityView;
import qtc.project.banhangnhanh.admin.views.activity.notify_manager_activity.NotificationManagerActivityViewCallback;
import qtc.project.banhangnhanh.admin.views.activity.notify_manager_activity.NotificationManagerActivityViewInterface;
...
public class NotificationManagerActivity extends BaseFragmentActivity<NotificationManagerActivityViewInterface, BaseMainActionbarViewInterface, BaseParameters> implements NotificationManagerActivityViewCallback {
    ...
    public void onFragmentNotificationBackEvent(FragmentNotificationBackEvent event) {
        if (view != null) {
            Intent refresh = new Intent(NotificationManagerActivity.this, SaleHomeActivity.class);
