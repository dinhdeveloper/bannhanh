...
public class BaoCaoNhapKhoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    BaoCaoNhapKhoAdapterListener listener;

    public interface BaoCaoNhapKhoAdapterListener {
        void onClickItem(PackageInfoModel model);
    }

    public void setListener(BaoCaoNhapKhoAdapterListener listener) {
        this.listener = listener;
    }

    public BaoCaoNhapKhoAdapter(Context context, List<PackageInfoModel> list) {
