...
public class FragmentFilterTomTatDoanhSoView extends BaseView<FragmentFilterTomTatDoanhSoView.UIContainer> implements FragmentFilterTomTatDoanhSoViewInterface {

    HomeActivity activity;
    FragmentFilterTomTatDoanhSoViewCallback callback;
    ...
    @Override
    public void init(HomeActivity activity, FragmentFilterTomTatDoanhSoViewCallback callback) {
    ...
    @Override
    public void sentDataDayChoose(int date) {
        ui.layout_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (callback!=null){
                    callback.filterDataTheoThang(arr_year[positionItemYearSelected],String.valueOf(positionItemMonthSelected),date);
                }
            }
        });
        //back
    ...
    private void onClick() {
        ...
        ui.layout_search.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (callback!=null){
                    callback.filterDataYear(arr_year[positionItemYearSelected]);
                }
            }
        });
    }
...
//                }, DELAY);
    ...
    public BaseUiContainer getUiContainer() {
        return new FragmentFilterTomTatDoanhSoView.UIContainer();
    }

    @Override
    public int getViewId() {
        return R.layout.layout_fragment_filter_bao_cao_xuat_nhap_kho;
    }
