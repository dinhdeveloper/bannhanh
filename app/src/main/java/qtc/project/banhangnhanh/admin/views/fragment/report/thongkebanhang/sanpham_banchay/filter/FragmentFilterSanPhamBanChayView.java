package qtc.project.banhangnhanh.admin.views.fragment.report.thongkebanhang.sanpham_banchay.filter;
...
public class FragmentFilterSanPhamBanChayView extends BaseView<FragmentFilterSanPhamBanChayView.UIContainer> implements FragmentFilterXuatNhapKhoViewInterface {

    HomeActivity activity;
    FragmentFilterXuatNhapKhoViewCallback callback;
    ...
    @Override
    public void init(HomeActivity activity, FragmentFilterXuatNhapKhoViewCallback callback) {
...
//                }, DELAY);
    ...
    public BaseUiContainer getUiContainer() {
        return new FragmentFilterSanPhamBanChayView.UIContainer();
    }

    @Override
    public int getViewId() {
        return R.layout.layout_fragment_filter_san_pham_ban_chay;
    }
